...
interface UserDao {
    ...
    @Query("SELECT * FROM user WHERE email = :email AND phone = :phone AND password = :password LIMIT 1")
    suspend fun getUser(email: String, password: String, phone: String): User?
